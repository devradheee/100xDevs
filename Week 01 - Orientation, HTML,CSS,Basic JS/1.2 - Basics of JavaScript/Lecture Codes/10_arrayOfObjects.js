...
console.log(arr[0]); //  Radheshyam
console.log(arr[1]); // 21
console.log(arr[2]); // { name: ' Radheshyam', age: 21, cities: [ 'Delhi', 'Mumbai', 'Bangalore', { country: 'India', population: 1500000000 } ] }
console.log(arr[2].name); //  Radheshyam
